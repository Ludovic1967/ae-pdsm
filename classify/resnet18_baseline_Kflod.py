...
def main(args):
    ...
    final_model.conv1 = nn.Conv2d(4, 64, kernel_size=7, stride=2, padding=3, bias=False)  # 4-channel input
    final_model.fc = nn.Linear(model.fc.in_features, 2)  # 2-class output
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='resnet18_baseline', type=str, help='Model name used for logging')
